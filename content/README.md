...
- `scene-data/hero-street.paintover.json` defines the active Hero Shot Paintover Pass target zones for composition, material, light, human scale, and historical restraint.
